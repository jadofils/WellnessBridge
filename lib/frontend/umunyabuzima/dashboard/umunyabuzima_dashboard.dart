...
import 'package:wellnessbridge/frontend/admin/birth_property/birth_property_list.dart';

class UmunyabuzimaDashboard extends StatefulWidget {
  const UmunyabuzimaDashboard({super.key});

  @override
  _UmunyabuzimaDashboardState createState() => _UmunyabuzimaDashboardState();
}

class _UmunyabuzimaDashboardState extends State<UmunyabuzimaDashboard> {
  ...
  Widget _buildBody() {
    switch (_selectedIndex) {
      ...
      case 2:
        return const BirthPropertyList();
      case 3:
        return Center(child: Text('Health Restrictions'));
      case 4:
        return Center(child: Text('My Projects'));
      case 5:
        return Center(child: Text('Settings'));
      default:
        return Center(child: Text('Welcome to Health Worker Dashboard'));
    }
  }
